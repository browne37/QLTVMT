...
CREATE DATABASE [QLTV74]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'QLTV74', FILENAME = N'D:\sql\QLTV74.mdf' , SIZE = 4096KB , MAXSIZE = UNLIMITED, FILEGROWTH = 1024KB )
 LOG ON 
( NAME = N'QLTV74_log', FILENAME = N'D:\sql\QLTV74_log.ldf' , SIZE = 3456KB , MAXSIZE = UNLIMITED, FILEGROWTH = 10%)
...
-- Thêm dữ liệu mẫu
INSERT INTO DAUSACH (MADAUSACH, TENSACH, TENTACGIA, THELOAI, NAMXB, NXB, NGONNGU, SOLUONG) 
VALUES 
('DS001', 'Lập trình Python', 'Nguyễn Văn A', 'Công nghệ', 2020, 'NXB Giáo Dục', 'Tiếng Việt', 10),
('DS002', 'Dữ liệu lớn', 'Trần Văn B', 'Khoa học', 2018, 'NXB Khoa học', 'Tiếng Anh', 5);

INSERT INTO SACH (MASACH, MADAUSACH, TINHTRANG, VITRI)
VALUES 
('S001', 'DS001', 'Còn mượn', 'Kệ A1'),
('S002', 'DS002', 'Đang mượn', 'Kệ B2');

INSERT INTO DOCGIA (MADG, TENDG, NGAYSINH, GT, DIACHI)
VALUES 
('DG001', 'Lê Thị C', '1990-05-01', 'Nữ', 'Hà Nội'),
('DG002', 'Hoàng Văn D', '1985-07-15', 'Nam', 'TP HCM');

INSERT INTO NhanVien (MANV, TENNV, CHUCVU, NGAYVAOLAM)
VALUES 
('NV001', 'Trần Thị E', 'Thủ thư', '2020-01-15'),
('NV002', 'Nguyễn Văn F', 'Quản lý', '2019-03-20');